...
/* lex.c 1081 */
/* prototypes of private functions that help with [[getpar]] 1082e */
static Name readatom(const char **ps);
/* prototypes of private functions that help with [[getpar]] 1083b */
static Parlist reverse_parlist(Parlist p);
/* prototypes of private functions that help with [[getpar]] 1084b */
static int  isdelim(char c);
static Name strntoname(const char *s, int n);
/* prototypes of private functions that help with [[getpar]] 1084d */
...
static Par getpar_in_context(Parstream pars, bool is_first, char left) {
    if (pars->input == NULL)
        ...
        /* advance [[pars->input]] past whitespace characters 1082b */
        ...
        case '(': case '[': 
            /* read and return a parenthesized [[LIST]] 1082f */
            {
        ...
        default:
         ...
         /* read a [[Par]] and return that [[Par]] wrapped in [[quote]] 1082c */
                {
                    pars->input++;
